...
class HTMLNode:
    def __init__(self, tag: None | str = None, value: None | str = None, children: None | list[HTMLNode] = None, props: None | dict = None) -> None:
        self.tag: None | str = tag
        self.value: None | str = value
        self.children: None | list[HTMLNode] = children
